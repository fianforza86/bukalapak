...
WebUI.setEncryptedText(findTestObject('Object Repository/Bukalapak.com/Page_Login ke Akun  Bukalapak/input_Password'), '9yJ00lObren76rbIy/9lPA==')

WebUI.click(findTestObject('Object Repository/Bukalapak.com/Page_Login ke Akun  Bukalapak/button_Login'))

WebUI.click(findTestObject('Object Repository/Bukalapak.com/Page_Situs Belanja Online dan Jual Beli Mud_3c8940/img'))
